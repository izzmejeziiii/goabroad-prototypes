...
export const adSections: AdSection[] = [
    ...
    },
    {
        ...
        title: "Article Directory Advertising",
        navLabel: "Article Directory",
        description:
            "Reach readers in the middle of GoAbroad's editorial content — placed around articles associated with your selected directory.",
        ads: [
            {
                id: "ad-dd",
                code: "Ad DD",
                name: "Article Directory Organizational Feature",
                imageSizes: [
                    { w: 390, h: 185, label: "Desktop" },
                    { w: 120, h: 120, label: "Mobile" },
                ],
                quickFacts: ["85-char title", "390 × 185 / 120 × 120 px images"],
                fields: [
                    {
                        label: "Placement",
                        notes: [
                            "On mobile, the ad is the first thing a reader sees, immediately at the top of the article",
                            "On desktop, the ad is the first thing a reader sees immediately under the article header on the right hand side",
                            "Only displayed on articles associated with the selected directory that do not have an associated country or region",
                        ],
                    },
                    {
                        label: "Title",
                        headline: "85 characters max",
                        notes: [
                            "Write one short sentence",
                            "Start with an action word to evoke action!",
                            "Can mention destination(s) of program",
                            "Choose a URL on your website to link to",
                        ],
                    },
                    {
                        label: "Image",
                        headline: "390 × 185 px (desktop) · 120 × 120 px (mobile)",
                        notes: [
                            "Image cannot have any text, graphics, or logo overlay",
                            "Choose a high quality image that relates to the feature",
                        ],
                ...
                tips: [
                    "Choose an image that works well for both mobile and desktop.",
                    "Use your organization name as the title for additional brand recognition.",
                    "Mention the type of directory program offerings you want to entice users about.",
                ],
            },
            {
                id: "ad-ee",
                code: "Ad EE",
                name: "Article Directory Feature",
                imageSizes: [
                    { w: 390, h: 185, label: "Desktop" },
                    { w: 120, h: 120, label: "Mobile" },
                ],
                ...
                fields: [
                    {
                        label: "Placement",
                        notes: [
                            "On desktop, the ad appears at the end of the article in the right hand side bar",
                            "On mobile, the ad appears directly after the body content ends",
                            "Only displayed on articles associated with the selected directory that do not have an associated country, region, or type",
                        ],
                    },
                    {
                        label: "Title",
                ...
                autoPulled: ["Logo — from your account"],
                tips: [
                    "Be sure the text is enticing to users moving down the page as they are reading the article so you can stand out.",
                    "Use an image that is rather close-up and easy to visually understand rather than just a landscape (since your logo will be in front).",
                ],
            },
        ],
    },
    {
        ...
        ads: [
            ...
            },
            {
                id: "ad-oo",
                code: "Ad OO",
                name: "Directory Travel Resource Feature",
                imageSizes: [
                    { w: 1168, h: 150, label: "Desktop" },
                    { w: 414, h: 150, label: "Mobile" },
                ],
                quickFacts: ["70-char title", "1168 × 150 px banner"],
                fields: [
                    {
                        label: "Placement",
                        notes: [
                            "Bottom of the directory homepage, directly after Popular Searches",
                            "Displays the ad on the homepage and the search pages associated with the selected directory",
                        ],
                    },
                    {
                        label: "Title",
                        ...
                        notes: [
                            "Write one short sentence",
                            "Start with an action word to evoke action!",
                            "Can mention the highlights of the product or service",
                        ],
                    },
                    {
                        label: "Image",
                        headline: "1168 × 150 px (desktop) · 414 × 150 px (mobile)",
                        notes: [
                            "Image cannot have any text, graphics, or logo overlay",
                            "Choose a high-quality image that relates to the feature",
                        ],
                    ...
                    {
                        label: "Link",
                        notes: ["Choose a URL on your website"],
                    },
                ],
                autoPulled: ["Logo — from your account"],
                tips: [
                    "Be sure the title and first sentence are enticing — users are moving down the page reading the listings, so you want to stand out.",
                    "Use an image that is rather close-up and easy to visually understand rather than just a landscape (since your logo will be in front).",
                ],
            },
        ],
