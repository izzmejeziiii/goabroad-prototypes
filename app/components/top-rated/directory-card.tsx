...
export default function DirectoryCard({
    ...
    return (
        <Link
            ...
            className="group flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-2.5 shadow-sm transition-all hover:-translate-y-0.5 hover:border-cobalt-200 hover:shadow-lg hover:shadow-cobalt-500/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-cobalt-500 focus-visible:ring-offset-2 sm:p-3"
        >
            ...
            <div className="relative flex flex-1 items-end justify-between gap-3 px-1.5 pt-7 pb-1.5 sm:px-2 sm:pt-8 sm:pb-2">
                ...
                <div className="min-w-0">
                    <h4 className="text-base leading-snug font-bold text-neutral-800 transition-colors group-hover:text-cobalt-600 sm:text-lg">
                        {directory.cardTitle}
                    </h4>
