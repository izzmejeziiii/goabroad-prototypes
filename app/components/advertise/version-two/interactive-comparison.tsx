        ...
        return navLink.map((navLink, index) => {
            ...
            return (
                <Link
                    ...
                    className={`${defaultClass ?? ""} group mb-1 flex justify-between py-1.5 px-2 [&:not(.feature-selected)]:hover:bg-primary-50`}
                    onClick={adScroll}
                    href="#"
                    key={index}
                >
                    <div className="flex items-center gap-2 md:gap-3">
                        <span className="flex h-7.5 w-7.5 shrink-0 items-center justify-center rounded-full border-[3px] border-gray-300 pt-px text-xs text-gray-300 group-hover:bg-cobalt-500/60 group-hover:border-none group-[.feature-selected]:group-hover:bg-cobalt-500 group-[.feature-selected]:group-hover:border-none">
                            {num}
                        </span>
                        <p className="text-sm text-slate-700">{linkText}</p>
                    </div>
                    <div className="my-auto flex w-27.5 shrink-0 justify-between">
                        <div>{firstIcon}</div>
                        <div>{secondIcon}</div>
                    </div>
                </Link>
    ...
    return (
        <div className="flex w-full flex-col items-center">
            ...
            >
                ...
                <div className="flex w-full flex-wrap items-center gap-4 xl:flex-nowrap mt-8">
                    ...
                    <div className="screen-nav w-full">
                        <div className="relative mb-4 border-b border-b-gray-300 pb-2 flex justify-between font-bold uppercase">
