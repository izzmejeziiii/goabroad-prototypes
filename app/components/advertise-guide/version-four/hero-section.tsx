                ...
                <div className="text-slate-800 max-w-4xl text-center flex flex-col gap-12 items-center justify-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link
                            ...
                            className="bg-white rounded-md text-cobalt-500 py-3 px-6 border border-cobalt-500 hover:bg-cobalt-500 hover:text-white transition-colors duration-300 font-semibold"
                        >
                            Book A Demo
                        </Link>
                    </div>
