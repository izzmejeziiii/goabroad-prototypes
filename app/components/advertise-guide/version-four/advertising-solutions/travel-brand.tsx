            ...
            <div className="w-full grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                    <div className="space-y-3 text-slate-700 leading-relaxed">
                        ...
                        <p>
                            These promotional options connect your services with
                            GoAbroad’s engaged audience of students and
                            professionals looking for travel-related services.
                            This strategic placement helps position your brand
                            as an essential part of the international travel
                            experience.
                        </p>
                    </div>

                    <div>
                        <p className="text-cobalt-500 text-xs font-semibold uppercase tracking-wider mb-3">
                            Strategic impact
                        </p>
                        ...
                        <div className="border-sun-200/50 flex w-full items-center gap-4 rounded-md border bg-amber-50 px-6 py-4">
                            ...
                            <div className="w-full flex flex-col gap-1">
                                ...
                                <p className="text-slate-800">
                                    Pre-departure oriented brands, added
