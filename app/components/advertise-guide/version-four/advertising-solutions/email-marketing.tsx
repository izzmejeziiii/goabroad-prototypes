                ...
                <div className="space-y-6">
                    <div className="space-y-3 text-slate-700 leading-relaxed">
                        <span className="font-bold text-slate-800">
                            Reach engaged subscribers at key enrollment moments
                        </span>
                        <p>
                            By leveraging GoAbroad’s targeted email lists of
                            over 80k, you gain direct access to users who are
                            actively researching global opportunities,
                            increasing the likelihood of immediate conversions.
                            These campaigns help drive urgent action during key
                            enrollment windows, keeping your brand top-of-mind
