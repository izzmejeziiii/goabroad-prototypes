...
export default function GoabroadAdvertising() {
    return (
        <div className="w-full h-full flex flex-col items-center justify-center my-14 px-4 md:px-6 lg:px-8 xl:px-0">
            <section className="w-full max-w-7xl py-8 md:px-6 px-4 lg:p-10 bg-primary-50 rounded-2xl ">
                <div className="w-full flex flex-col items-center gap-8 justify-center">
                    <h2 className="text-slate-800 mb-8 font-bold text-[28px] text-center">
                        How GoAbroad Advertising Supports <br /> SEO & AI
                        Discoverability
                    </h2>
                    <div className="space-y-4 text-slate-700">
                        <p>
                            As AI-driven discovery becomes more prominent,
                            authoritative third-party citations matter.
                            Visibility within GoAbroad
                            <strong>
                        ...
                        <p>
                            Advertising on GoAbroad does more than generate
                            clicks; GoAbroad is a high-authority domain within
                            international education, so your presence on our
                            platform contributes to:
                        </p>
                    </div>
                    <div className="w-full grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="border border-gray-300 rounded-xl relative bg-slate-50 p-6 overflow-hidden">
                            <div className="space-y-4 w-full text-slate-700">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm">
                                        Increased brand association within
                                        trusted industry contexts
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="border border-gray-300 rounded-xl relative bg-slate-50 p-6 overflow-hidden">
                            <div className="space-y-4 w-full text-slate-700">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm">
                                        Enhanced discoverability through
                        ...
                        <div className="border border-gray-300 rounded-xl relative bg-slate-50 p-6 overflow-hidden">
                            <div className="space-y-4 w-full text-slate-700">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm">
                                        Greater likelihood of being referenced
                                        in AI-generated summaries and
