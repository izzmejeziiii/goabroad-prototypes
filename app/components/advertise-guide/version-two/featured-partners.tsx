                ...
                <div className="grid w-full md:grid-cols-4 grid-cols-2 lg:grid-cols-6 gap-6">
                    {partners.map((partner, index) => (
                        <Link
                            key={index}
                            href={partner.href}
                            className="p-6 border border-gray-300 rounded-lg flex items-center hover:scale-105 hover:shadow-md hover:shadow-primary-50 transition-all duration-300 justify-center flex-col gap-2 group"
                        >
                            <Image
                                src={partner.image}
