...
export default function GoabroadPartner() {
    return (
        <div className="w-full flex flex-col items-center justify-center px-4 md:px-6 lg:px-8 xl:px-0">
            <section className="w-full max-w-7xl bg-primary-50/70 rounded-2xl py-8 md:px-6 px-4 lg:p-10 flex flex-col items-center justify-center">
